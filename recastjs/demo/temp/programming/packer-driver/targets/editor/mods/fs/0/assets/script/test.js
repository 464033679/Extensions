System.register(["cce:/internal/code-quality/cr.mjs", "cc", "./recastdetourjs/tool/RecastDetourManager", "./recastdetourjs/tool/recastJsPlugin"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Test", Test = (_dec = ccclass('Test'), _dec2 = property(cc.Node), _dec3 = property(cc.Node), _dec4 = property(cc.Node), _dec5 = property(cc.Camera), _dec6 = property(cc.Material), _dec(_class = (_class2 = (_temp = class Test extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "roleNode", _descriptor, this);

          _initializerDefineProperty(this, "cylinderObstacleNode", _descriptor2, this);

          _initializerDefineProperty(this, "boxObstacleNode", _descriptor3, this);

          _initializerDefineProperty(this, "camera", _descriptor4, this);

          _initializerDefineProperty(this, "debugMaterial", _descriptor5, this);

          _defineProperty(this, "type", 1);

          _defineProperty(this, "obstacleList", []);

          _defineProperty(this, "yKey", 0);

          _defineProperty(this, "xKey", 0);

          _defineProperty(this, "startLinkPos", void 0);
        }
        ...
        loadBin() {
          cc.resources.load("solo_navmesh", cc.Asset, (err, asset) => {
            this.recastDetourManager = (_crd && RecastDetourManager === void 0 ? (_reportPossibleCrUseOfRecastDetourManager({
              error: Error()
            }), RecastDetourManager) : RecastDetourManager).getInstanceByBin(asset._file, this.debugMaterial, 1);
          });
        }
        ...
        exportObj() {
          ...
          let str = (_crd && RecastJSPlugin === void 0 ? (_reportPossibleCrUseOfRecastJSPlugin({
            error: Error()
      ...
      }, _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "roleNode", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
