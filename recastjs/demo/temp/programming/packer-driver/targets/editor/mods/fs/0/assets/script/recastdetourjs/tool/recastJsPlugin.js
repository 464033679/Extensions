System.register(["cce:/internal/code-quality/cr.mjs", "cc"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, math, Vec3, cc, RecastJSPlugin, RecastJSCrowd, _crd, Epsilon, RecastConfig;
  ...
  _export({
    RecastJSPlugin: void 0,
    RecastJSCrowd: void 0
  });
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RecastJSPlugin", RecastJSPlugin = class RecastJSPlugin {
        /**
        ...
        createNavMesh(meshes, parameters) {
          ...
          let {
            ...
            startId,
            facesTypeArray
          } = RecastJSPlugin.getMeshData(meshes);
        ...
        static exportObj(meshes) {
          let output = [];
          let {
            vertexTypeArray,
            facesTypeArray,
            group
          } = this.getMeshData(meshes);
        ...
        static createMeshRenderer(scene, positions, indices) {
      ...
      _export("RecastJSCrowd", RecastJSCrowd = class RecastJSCrowd {
        /**
        ...
        static getWorldPosition(recastPos) {
